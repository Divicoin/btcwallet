...
[![GoDoc](https://godoc.org/github.com/Divicoin/btcwallet/walletdb?status.png)]
(http://godoc.org/github.com/Divicoin/btcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/Divicoin/btcwallet/walletdb

## Installation

```bash
$ go get github.com/Divicoin/btcwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/Divicoin/btcwallet/walletdb#example-package--BasicUsage)  
